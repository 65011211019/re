            ...
            {!selectedEvent ? (
                <Card className="shadow-xl border-0 h-full bg-gradient-to-br from-white to-blue-50/30 backdrop-blur-sm">
                    ...
                    <CardContent className="p-6 text-center text-gray-600 space-y-4">
                        ...
                        {bufferSettings && (
                            <div className="p-4 bg-gray-100 rounded-lg border border-gray-200 text-left text-sm space-y-2">
        ...
        <Card className="shadow-md border-0 bg-white">
            ...
            <CardContent>
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
                    ...
                    {bufferSettings?.enable_buffer_time && (
                        <>
                           <div className="flex items-center space-x-2">
                                <div className="w-3 h-3 rounded-full bg-orange-500"></div>
                                <span className="text-sm text-gray-600">Buffer (จัดส่ง)</span>
                            </div>
                            <div className="flex items-center space-x-2">
                                <div className="w-3 h-3 rounded-full bg-purple-500"></div>
                                <span className="text-sm text-gray-600">Buffer (รับคืน)</span>
                            </div>
                        </>
                    )}
                </div>
